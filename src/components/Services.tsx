        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-3">
            <motion.div 
              ...
              className="bg-gray-50 rounded-2xl overflow-hidden h-full p-8"
            >
              <div className="flex items-center mb-6">
                <div className={`rounded-full p-4 mr-4 ${activeService.color}`}>
                  {activeService.icon}
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm mb-6">
                <h4 className="font-semibold mb-2 text-lg">Detaylı Bilgi</h4>
                <p className="text-gray-600">{activeService.details}</p>
              </div>
              
              <button className="px-6 py-3 bg-primary text-white rounded-md font-medium hover:bg-primary-light transition-colors">
                Detaylı Bilgi
              </button>
            </motion.div>
          </div>
