...
export async function POST(request: Request) {
  try {
    ...
    // Inline olarak logo eklemek için CID kullanımı
    const logoAttachment = {
      filename: 'logo2k.png',
      path: 'https://www.2kegitim.com/images/logo/logo2k.png',
      cid: 'logo@2kegitim.com' // CID referans için benzersiz bir tanımlayıcı
    };
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #f0f0f0; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="cid:logo@2kegitim.com" alt="2K Eğitim Logo" style="max-width: 200px; width: 100%;">
          </div>
    ...
    const ownerMailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #f0f0f0; border-radius: 10px;">
          <div style="text-align: center; margin-bottom: 20px;">
            <img src="cid:logo@2kegitim.com" alt="2K Eğitim Logo" style="max-width: 150px; width: 100%;">
          </div>
